...
Podvault 0.4.0 supports Linux x86-64 and ARM64. Transfer these trusted release
files to the pod:

```text
bootstrap-linux.sh
podvault-0.4.0-py3-none-any.whl
```
...
/opt/podvault-venv/bin/pip install ./podvault-0.4.0-py3-none-any.whl
